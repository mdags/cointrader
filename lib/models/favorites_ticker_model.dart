...
List<FavoritesTickersModel> favoritesTickersModelFromJson(String str) =>
    List<FavoritesTickersModel>.from(
        json.decode(str).map((x) => FavoritesTickersModel.fromJson(x)));

String favoritesTickersModelToJson(List<FavoritesTickersModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class FavoritesTickersModel {
  FavoritesTickersModel({
    this.base,
    this.target,
    this.market,
    this.last,
  ...
  factory FavoritesTickersModel.fromJson(Map<String, dynamic> json) =>
      FavoritesTickersModel(
        base: json["base"],
        target: json["target"],
